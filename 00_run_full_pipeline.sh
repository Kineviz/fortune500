...
# Initialize tables
sed "s/sec_filings\./${BQ_DATASET}./g" 04_init_tables.sql | bq query --use_legacy_sql=false --location="$BQ_LOCATION"
...
sed "s/sec_filings\./${BQ_DATASET}./g" 05_extraction.sql | bq query --use_legacy_sql=false --location="$BQ_LOCATION"
...
sed "s/sec_filings\./${BQ_DATASET}./g" 06_create_property_graph_ddl.sql | bq query --use_legacy_sql=false --location="$BQ_LOCATION"
